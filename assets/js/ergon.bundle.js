  ...
  document.querySelectorAll('.table-responsive').forEach(container => {
    ...
    tables.forEach(table => {
      const headers = Array.from(table.querySelectorAll('thead th'))
        .map(th => th.textContent.trim().replace(/[â‡…ðŸ”â–²â–¼]/g, '').trim());
            ...
            cell.innerHTML = `
                <div class="table-header__content">
                    ...
                    <div class="table-header__controls">
                        <span class="table-header__sort" data-column="${columnKey}" data-direction="none">â‡…</span>
                        <span class="table-header__filter" data-column="${columnKey}">ðŸ”</span>
                    </div>
                </div>
