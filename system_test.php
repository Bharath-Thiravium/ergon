...
<body>
    ...
    <div class="test-section">
        <h2>Access URLs</h2>
        <p><a href="/ergon_clean/" target="_blank">🏠 Main Application</a></p>
        <p><a href="/ergon_clean/public/login" target="_blank">🔐 Login Page</a></p>
        <p><a href="/ergon_clean/public/dashboard" target="_blank">📊 Dashboard</a></p>
    </div>
