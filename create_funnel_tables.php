...
try {
    ...
    $db->exec("CREATE TABLE IF NOT EXISTS funnel_stats (
    ...
    $db->exec("CREATE TABLE IF NOT EXISTS chart_stats (
        id INT PRIMARY KEY AUTO_INCREMENT,
        company_prefix VARCHAR(50) NOT NULL,
    ...
    echo "- funnel_stats table created\n";
    echo "- chart_stats table created\n";
