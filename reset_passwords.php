...
try {
    ...
    echo "<ul>";
    echo "<li><strong>Owner:</strong> Use any owner email with password 'owner123'</li>";
    echo "<li><strong>Admin:</strong> Use any admin email with password 'admin123'</li>";
    echo "<li><strong>User:</strong> Use any user email with password 'user123'</li>";
    echo "</ul>";
    echo "</div>";
...
echo " | <a href='/ergon/show-credentials'>📋 View All Credentials</a>";
?>