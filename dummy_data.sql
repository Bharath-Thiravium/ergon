...
-- Daily Tasks (for daily planner workflow)
...
(1, 1, '2025-11-15', 'Database Backup Setup', 'Configure automated daily database backups', '09:00:00', 120, 'high', 'in_progress', 3600, 60),
(2, 3, '2025-11-15', 'Client Presentation Prep', 'Prepare presentation for new client onboarding', '10:30:00', 180, 'high', 'paused', 1800, 25),
(16, 4, '2025-11-15', 'GST Return Filing', 'File monthly GST returns for October', '08:30:00', 240, 'high', 'in_progress', 7200, 80),
(1, NULL, '2025-11-15', 'Team Standup Meeting', 'Daily team coordination meeting', '11:00:00', 30, 'medium', 'completed', 1800, 100),
(2, 2, '2025-11-16', 'Invoice Template Update', 'Update invoice templates with new company branding', '09:30:00', 90, 'medium', 'not_started', 0, 0);

-- Time Logs (for tracking task time)
...
-- Daily Performance (for statistics)
