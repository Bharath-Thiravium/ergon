...
<head>
    ...
    /* Global Back Button */
    .global-back-btn{position:fixed !important;top:120px !important;right:10px !important;left:auto !important;z-index:1000;background:#fff;border:2px solid #e2e8f0;border-radius:50%;width:44px;height:44px;display:flex;align-items:center;justify-content:center;cursor:pointer;box-shadow:0 2px 8px rgba(0,0,0,0.1);transition:all 0.2s ease}
