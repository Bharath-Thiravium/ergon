                                ...
                                <td>
                                    <div class="ab-container">
                                        ...
                                        <?php if (($_SESSION['role'] ?? '') === 'owner'): ?>
                                            ...
                                            <button class="ab-btn ab-btn--progress" onclick="resetPassword(<?= $user['id'] ?>, '<?= $userName ?>')" data-tooltip="Reset Password">
                                            ...
                                            <?php if ($userStatus === 'active'): ?>
                                                ...
                                                <button class="ab-btn ab-btn--danger" onclick="suspendUser(<?= $user['id'] ?>, '<?= $userName ?>')" data-tooltip="Suspend User">
                                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><line x1="22" y1="11" x2="16" y2="11"/></svg>
                                                </button>
                                                <button class="ab-btn ab-btn--delete" onclick="deleteUser(<?= $user['id'] ?>, '<?= $userName ?>')" data-tooltip="Terminate User">
                                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><line x1="17" y1="8" x2="22" y2="13"/><line x1="22" y1="8" x2="17" y2="13"/></svg>
                                                </button>
                                            <?php elseif ($userStatus === 'inactive' || $userStatus === 'suspended'): ?>
                                                <button class="ab-btn ab-btn--success" onclick="activateUser(<?= $user['id'] ?>, '<?= $userName ?>')" data-tooltip="Activate User">
                                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M9 12l2 2 4-4"/><circle cx="12" cy="12" r="10"/></svg>
                                                </button>
                                                <button class="ab-btn ab-btn--delete" onclick="deleteUser(<?= $user['id'] ?>, '<?= $userName ?>')" data-tooltip="Terminate User">
                                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><line x1="17" y1="8" x2="22" y2="13"/><line x1="22" y1="8" x2="17" y2="13"/></svg>
                                                </button>
                                            ...
                                            <?php endif; ?>
                                        <?php elseif (($_SESSION['role'] ?? '') === 'admin' && ($user['role'] ?? 'user') === 'user'): ?>
