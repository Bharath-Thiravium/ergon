...
echo "<a href='/ergon_clean/public/' style='margin: 5px; padding: 8px 15px; background: #007bff; color: white; text-decoration: none; border-radius: 4px;'>🏠 Main Application</a>";
echo "<a href='/ergon_clean/public/login' style='margin: 5px; padding: 8px 15px; background: #28a745; color: white; text-decoration: none; border-radius: 4px;'>🔐 Login Page</a>";
